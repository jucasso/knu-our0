...
function projectComponent(project) {
  return `<div class="border a_project inner">
            <div class="border project_img">
              <a href="/exhibition/a_project.html?project_name=${encodeURIComponent(project.project_name)}">
                <img
...
fetch("../public/test.json") // JSON 파일 경로 맞게 수정
